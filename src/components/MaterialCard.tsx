    ...
    >
      ...
      >
        <div className="pt-3">
          ...
          <ScoreBreakdown material={material} weights={weights} />
          ...
          <div className="mt-3 text-right text-[10px] italic text-surface-700">
            {material.source_url ? (
              <a
                ...
                className="inline-flex items-center gap-1 text-blue-400 transition hover:text-blue-300 hover:underline"
              >
                View datasheet →
              </a>
            ) : (
              <span>Source: {material.data_source}</span>
            )}
          </div>
        </div>
      </div>
